...
--[[
  ...
  See ProjectTree:PostLoadPrecache() in projecttree.lua for more information
  ]]

  DebugPrint("[PROJECTTREE] Performing pre-load precache")
  ...
  PrecacheUnitByNameSync("npc_dota_warlock_golem_1", context)
  PrecacheUnitByNameSync("npc_dota_warlock_golem_2", context)
...
function Activate()
  GameRules.ProjectTree = ProjectTree()
  GameRules.ProjectTree:_InitProjectTree()
end
