...
--[[
  ...
  -Ensure that you have the projecttree_attachments.xml, projecttree_attachments.js, and projecttree_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that projecttree_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/projecttree_attachments.xml" />
