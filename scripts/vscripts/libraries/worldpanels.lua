...
--[[
  ...
  -Ensure that you have the projecttree_worldpanels.xml in your panorama content layout folder.
  -Ensure that you have the projecttree_worldpanels.js in your panorama content scripts folder.
  -Ensure that projecttree_worldpanels.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/projecttree_worldpanels.xml" />
