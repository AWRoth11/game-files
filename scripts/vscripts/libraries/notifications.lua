...
--[[
  ...
  -Ensure that you have the projecttree_notifications.xml, projecttree_notifications.js, and projecttree_notifications.css files in your panorama content folder.
  -Ensure that projecttree_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/projecttree_notifications.xml" />
